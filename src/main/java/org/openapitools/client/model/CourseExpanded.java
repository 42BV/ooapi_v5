...
import org.openapitools.client.model.CourseExpandedAllOf;
...
import org.openapitools.client.model.TimelineOverrideCourse;
 ...
 */
@JsonPropertyOrder({
  CourseExpanded.JSON_PROPERTY_COURSE_ID,
  CourseExpanded.JSON_PROPERTY_PRIMARY_CODE,
  CourseExpanded.JSON_PROPERTY_NAME,
  CourseExpanded.JSON_PROPERTY_ABBREVIATION,
  CourseExpanded.JSON_PROPERTY_STUDY_LOAD,
  CourseExpanded.JSON_PROPERTY_MODE_OF_DELIVERY,
  CourseExpanded.JSON_PROPERTY_DURATION,
  CourseExpanded.JSON_PROPERTY_FIRST_START_DATE,
  CourseExpanded.JSON_PROPERTY_DESCRIPTION,
  CourseExpanded.JSON_PROPERTY_TEACHING_LANGUAGE,
  CourseExpanded.JSON_PROPERTY_FIELDS_OF_STUDY,
  CourseExpanded.JSON_PROPERTY_LEARNING_OUTCOMES,
  CourseExpanded.JSON_PROPERTY_ADMISSION_REQUIREMENTS,
  CourseExpanded.JSON_PROPERTY_QUALIFICATION_REQUIREMENTS,
  CourseExpanded.JSON_PROPERTY_LEVEL,
  CourseExpanded.JSON_PROPERTY_ENROLLMENT,
  CourseExpanded.JSON_PROPERTY_RESOURCES,
  CourseExpanded.JSON_PROPERTY_ASSESSMENT,
  CourseExpanded.JSON_PROPERTY_LINK,
  CourseExpanded.JSON_PROPERTY_EDUCATION_SPECIFICATION,
  CourseExpanded.JSON_PROPERTY_ADDRESSES,
  CourseExpanded.JSON_PROPERTY_OTHER_CODES,
  CourseExpanded.JSON_PROPERTY_CONSUMERS,
  CourseExpanded.JSON_PROPERTY_EXT,
  CourseExpanded.JSON_PROPERTY_PROGRAMS,
  CourseExpanded.JSON_PROPERTY_COORDINATORS,
  CourseExpanded.JSON_PROPERTY_ORGANIZATION,
  CourseExpanded.JSON_PROPERTY_VALID_FROM,
  CourseExpanded.JSON_PROPERTY_VALID_TO,
  CourseExpanded.JSON_PROPERTY_TIMELINE_OVERRIDES
})
...
public class CourseExpanded {
  ...
  **/
  ...
  public CourseExpanded primaryCode(IdentifierEntry primaryCode) {
  ...
  **/
  ...
  public CourseExpanded name(List<LanguageTypedString> name) {
    
    this.name = name;
    return this;
  }

  public CourseExpanded addNameItem(LanguageTypedString nameItem) {
  ...
  **/
  ...
  public CourseExpanded abbreviation(String abbreviation) {
  ...
  **/
  ...
  public CourseExpanded studyLoad(StudyLoadDescriptor studyLoad) {
  ...
  **/
  ...
  public CourseExpanded modeOfDelivery(List<ModeOfDeliveryEnum> modeOfDelivery) {
    
    this.modeOfDelivery = modeOfDelivery;
    return this;
  }

  public CourseExpanded addModeOfDeliveryItem(ModeOfDeliveryEnum modeOfDeliveryItem) {
  ...
  **/
  ...
  public CourseExpanded duration(String duration) {
  ...
  **/
  ...
  public CourseExpanded firstStartDate(LocalDate firstStartDate) {
  ...
  **/
  ...
  public CourseExpanded description(List<LanguageTypedString> description) {
    
    this.description = description;
    return this;
  }

  public CourseExpanded addDescriptionItem(LanguageTypedString descriptionItem) {
  ...
  **/
  ...
  public CourseExpanded teachingLanguage(String teachingLanguage) {
  ...
  **/
  ...
  public CourseExpanded fieldsOfStudy(String fieldsOfStudy) {
  ...
  **/
  ...
  public CourseExpanded learningOutcomes(List<List<LanguageTypedString>> learningOutcomes) {
    
    this.learningOutcomes = learningOutcomes;
    return this;
  }

  public CourseExpanded addLearningOutcomesItem(List<LanguageTypedString> learningOutcomesItem) {
  ...
  **/
  ...
  public CourseExpanded admissionRequirements(List<LanguageTypedString> admissionRequirements) {
    
    this.admissionRequirements = admissionRequirements;
    return this;
  }

  public CourseExpanded addAdmissionRequirementsItem(LanguageTypedString admissionRequirementsItem) {
  ...
  **/
  ...
  public CourseExpanded qualificationRequirements(List<LanguageTypedString> qualificationRequirements) {
    
    this.qualificationRequirements = qualificationRequirements;
    return this;
  }

  public CourseExpanded addQualificationRequirementsItem(LanguageTypedString qualificationRequirementsItem) {
  ...
  **/
  ...
  public CourseExpanded level(Level level) {
  ...
  **/
  ...
  public CourseExpanded enrollment(List<LanguageTypedString> enrollment) {
    
    this.enrollment = enrollment;
    return this;
  }

  public CourseExpanded addEnrollmentItem(LanguageTypedString enrollmentItem) {
  ...
  **/
  ...
  public CourseExpanded resources(List<String> resources) {
    
    this.resources = resources;
    return this;
  }

  public CourseExpanded addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public CourseExpanded assessment(List<LanguageTypedString> assessment) {
    
    this.assessment = assessment;
    return this;
  }

  public CourseExpanded addAssessmentItem(LanguageTypedString assessmentItem) {
  ...
  **/
  ...
  public CourseExpanded link(URI link) {
  ...
  **/
  ...
  public CourseExpanded educationSpecification(CoursePropertiesEducationSpecification educationSpecification) {
  ...
  **/
  ...
  public CourseExpanded addresses(List<Address> addresses) {
    
    this.addresses = addresses;
    return this;
  }

  public CourseExpanded addAddressesItem(Address addressesItem) {
  ...
  **/
  ...
  public CourseExpanded otherCodes(List<IdentifierEntry> otherCodes) {
    
    this.otherCodes = otherCodes;
    return this;
  }

  public CourseExpanded addOtherCodesItem(IdentifierEntry otherCodesItem) {
  ...
  **/
  ...
  public CourseExpanded consumers(List<Consumer> consumers) {
    
    this.consumers = consumers;
    return this;
  }

  public CourseExpanded addConsumersItem(Consumer consumersItem) {
  ...
  **/
  ...
  public CourseExpanded ext(Object ext) {
  ...
  **/
  ...
  public CourseExpanded programs(List<ProgramPropertiesChildrenInner> programs) {
    
    this.programs = programs;
    return this;
  }

  public CourseExpanded addProgramsItem(ProgramPropertiesChildrenInner programsItem) {
  ...
  **/
  ...
  public CourseExpanded coordinators(List<ProgramPropertiesCoordinatorsInner> coordinators) {
    
    this.coordinators = coordinators;
    return this;
  }

  public CourseExpanded addCoordinatorsItem(ProgramPropertiesCoordinatorsInner coordinatorsItem) {
  ...
  **/
  ...
  public CourseExpanded organization(CoursePropertiesOrganization organization) {
  ...
  **/
  ...
  public CourseExpanded validFrom(LocalDate validFrom) {
  ...
  **/
  ...
  public CourseExpanded validTo(LocalDate validTo) {
  ...
  **/
  ...
  public CourseExpanded timelineOverrides(List<TimelineOverrideCourse> timelineOverrides) {
    
    this.timelineOverrides = timelineOverrides;
    return this;
  }

  public CourseExpanded addTimelineOverridesItem(TimelineOverrideCourse timelineOverridesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CourseExpanded courseExpanded = (CourseExpanded) o;
    return Objects.equals(this.courseId, courseExpanded.courseId) &&
        Objects.equals(this.primaryCode, courseExpanded.primaryCode) &&
        Objects.equals(this.name, courseExpanded.name) &&
        Objects.equals(this.abbreviation, courseExpanded.abbreviation) &&
        Objects.equals(this.studyLoad, courseExpanded.studyLoad) &&
        Objects.equals(this.modeOfDelivery, courseExpanded.modeOfDelivery) &&
        Objects.equals(this.duration, courseExpanded.duration) &&
        Objects.equals(this.firstStartDate, courseExpanded.firstStartDate) &&
        Objects.equals(this.description, courseExpanded.description) &&
        Objects.equals(this.teachingLanguage, courseExpanded.teachingLanguage) &&
        Objects.equals(this.fieldsOfStudy, courseExpanded.fieldsOfStudy) &&
        Objects.equals(this.learningOutcomes, courseExpanded.learningOutcomes) &&
        Objects.equals(this.admissionRequirements, courseExpanded.admissionRequirements) &&
        Objects.equals(this.qualificationRequirements, courseExpanded.qualificationRequirements) &&
        Objects.equals(this.level, courseExpanded.level) &&
        Objects.equals(this.enrollment, courseExpanded.enrollment) &&
        Objects.equals(this.resources, courseExpanded.resources) &&
        Objects.equals(this.assessment, courseExpanded.assessment) &&
        Objects.equals(this.link, courseExpanded.link) &&
        Objects.equals(this.educationSpecification, courseExpanded.educationSpecification) &&
        Objects.equals(this.addresses, courseExpanded.addresses) &&
        Objects.equals(this.otherCodes, courseExpanded.otherCodes) &&
        Objects.equals(this.consumers, courseExpanded.consumers) &&
        Objects.equals(this.ext, courseExpanded.ext) &&
        Objects.equals(this.programs, courseExpanded.programs) &&
        Objects.equals(this.coordinators, courseExpanded.coordinators) &&
        Objects.equals(this.organization, courseExpanded.organization) &&
        Objects.equals(this.validFrom, courseExpanded.validFrom) &&
        Objects.equals(this.validTo, courseExpanded.validTo) &&
        Objects.equals(this.timelineOverrides, courseExpanded.timelineOverrides);
  }

  @Override
  public int hashCode() {
    return Objects.hash(courseId, primaryCode, name, abbreviation, studyLoad, modeOfDelivery, duration, firstStartDate, description, teachingLanguage, fieldsOfStudy, learningOutcomes, admissionRequirements, qualificationRequirements, level, enrollment, resources, assessment, link, educationSpecification, addresses, otherCodes, consumers, ext, programs, coordinators, organization, validFrom, validTo, timelineOverrides);
  }
