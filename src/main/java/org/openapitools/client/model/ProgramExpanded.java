...
import org.openapitools.client.model.ProgramExpandedAllOf;
...
import org.openapitools.client.model.TimelineOverrideProgram;
 ...
 */
@JsonPropertyOrder({
  ProgramExpanded.JSON_PROPERTY_PROGRAM_ID,
  ProgramExpanded.JSON_PROPERTY_PRIMARY_CODE,
  ProgramExpanded.JSON_PROPERTY_PROGRAM_TYPE,
  ProgramExpanded.JSON_PROPERTY_NAME,
  ProgramExpanded.JSON_PROPERTY_ABBREVIATION,
  ProgramExpanded.JSON_PROPERTY_DESCRIPTION,
  ProgramExpanded.JSON_PROPERTY_TEACHING_LANGUAGE,
  ProgramExpanded.JSON_PROPERTY_STUDY_LOAD,
  ProgramExpanded.JSON_PROPERTY_QUALIFICATION_AWARDED,
  ProgramExpanded.JSON_PROPERTY_MODE_OF_STUDY,
  ProgramExpanded.JSON_PROPERTY_MODE_OF_DELIVERY,
  ProgramExpanded.JSON_PROPERTY_DURATION,
  ProgramExpanded.JSON_PROPERTY_FIRST_START_DATE,
  ProgramExpanded.JSON_PROPERTY_LEVEL_OF_QUALIFICATION,
  ProgramExpanded.JSON_PROPERTY_LEVEL,
  ProgramExpanded.JSON_PROPERTY_SECTOR,
  ProgramExpanded.JSON_PROPERTY_FIELDS_OF_STUDY,
  ProgramExpanded.JSON_PROPERTY_ENROLLMENT,
  ProgramExpanded.JSON_PROPERTY_RESOURCES,
  ProgramExpanded.JSON_PROPERTY_LEARNING_OUTCOMES,
  ProgramExpanded.JSON_PROPERTY_ASSESSMENT,
  ProgramExpanded.JSON_PROPERTY_ADMISSION_REQUIREMENTS,
  ProgramExpanded.JSON_PROPERTY_QUALIFICATION_REQUIREMENTS,
  ProgramExpanded.JSON_PROPERTY_LINK,
  ProgramExpanded.JSON_PROPERTY_EDUCATION_SPECIFICATION,
  ProgramExpanded.JSON_PROPERTY_OTHER_CODES,
  ProgramExpanded.JSON_PROPERTY_ADDRESSES,
  ProgramExpanded.JSON_PROPERTY_PARENT,
  ProgramExpanded.JSON_PROPERTY_CHILDREN,
  ProgramExpanded.JSON_PROPERTY_COORDINATORS,
  ProgramExpanded.JSON_PROPERTY_ORGANIZATION,
  ProgramExpanded.JSON_PROPERTY_CONSUMERS,
  ProgramExpanded.JSON_PROPERTY_EXT,
  ProgramExpanded.JSON_PROPERTY_VALID_FROM,
  ProgramExpanded.JSON_PROPERTY_VALID_TO,
  ProgramExpanded.JSON_PROPERTY_TIMELINE_OVERRIDES
})
...
public class ProgramExpanded {
  ...
  **/
  ...
  public ProgramExpanded primaryCode(IdentifierEntry primaryCode) {
  ...
  **/
  ...
  public ProgramExpanded programType(ProgramType programType) {
  ...
  **/
  ...
  public ProgramExpanded name(List<LanguageTypedString> name) {
    
    this.name = name;
    return this;
  }

  public ProgramExpanded addNameItem(LanguageTypedString nameItem) {
  ...
  **/
  ...
  public ProgramExpanded abbreviation(String abbreviation) {
  ...
  **/
  ...
  public ProgramExpanded description(List<LanguageTypedString> description) {
    
    this.description = description;
    return this;
  }

  public ProgramExpanded addDescriptionItem(LanguageTypedString descriptionItem) {
  ...
  **/
  ...
  public ProgramExpanded teachingLanguage(String teachingLanguage) {
  ...
  **/
  ...
  public ProgramExpanded studyLoad(StudyLoadDescriptor studyLoad) {
  ...
  **/
  ...
  public ProgramExpanded qualificationAwarded(QualificationAwarded qualificationAwarded) {
  ...
  **/
  ...
  public ProgramExpanded modeOfStudy(ModeOfStudy modeOfStudy) {
  ...
  **/
  ...
  public ProgramExpanded modeOfDelivery(List<ModeOfDeliveryEnum> modeOfDelivery) {
    
    this.modeOfDelivery = modeOfDelivery;
    return this;
  }

  public ProgramExpanded addModeOfDeliveryItem(ModeOfDeliveryEnum modeOfDeliveryItem) {
  ...
  **/
  ...
  public ProgramExpanded duration(String duration) {
  ...
  **/
  ...
  public ProgramExpanded firstStartDate(LocalDate firstStartDate) {
  ...
  **/
  ...
  public ProgramExpanded levelOfQualification(LevelOfQualification levelOfQualification) {
  ...
  **/
  ...
  public ProgramExpanded level(Level level) {
  ...
  **/
  ...
  public ProgramExpanded sector(Sector sector) {
  ...
  **/
  ...
  public ProgramExpanded fieldsOfStudy(String fieldsOfStudy) {
  ...
  **/
  ...
  public ProgramExpanded enrollment(List<LanguageTypedString> enrollment) {
    
    this.enrollment = enrollment;
    return this;
  }

  public ProgramExpanded addEnrollmentItem(LanguageTypedString enrollmentItem) {
  ...
  **/
  ...
  public ProgramExpanded resources(List<String> resources) {
    
    this.resources = resources;
    return this;
  }

  public ProgramExpanded addResourcesItem(String resourcesItem) {
  ...
  **/
  ...
  public ProgramExpanded learningOutcomes(List<List<LanguageTypedString>> learningOutcomes) {
    
    this.learningOutcomes = learningOutcomes;
    return this;
  }

  public ProgramExpanded addLearningOutcomesItem(List<LanguageTypedString> learningOutcomesItem) {
  ...
  **/
  ...
  public ProgramExpanded assessment(List<LanguageTypedString> assessment) {
    
    this.assessment = assessment;
    return this;
  }

  public ProgramExpanded addAssessmentItem(LanguageTypedString assessmentItem) {
  ...
  **/
  ...
  public ProgramExpanded admissionRequirements(List<LanguageTypedString> admissionRequirements) {
    
    this.admissionRequirements = admissionRequirements;
    return this;
  }

  public ProgramExpanded addAdmissionRequirementsItem(LanguageTypedString admissionRequirementsItem) {
  ...
  **/
  ...
  public ProgramExpanded qualificationRequirements(List<LanguageTypedString> qualificationRequirements) {
    
    this.qualificationRequirements = qualificationRequirements;
    return this;
  }

  public ProgramExpanded addQualificationRequirementsItem(LanguageTypedString qualificationRequirementsItem) {
  ...
  **/
  ...
  public ProgramExpanded link(URI link) {
  ...
  **/
  ...
  public ProgramExpanded educationSpecification(ProgramPropertiesEducationSpecification educationSpecification) {
  ...
  **/
  ...
  public ProgramExpanded otherCodes(List<IdentifierEntry> otherCodes) {
    
    this.otherCodes = otherCodes;
    return this;
  }

  public ProgramExpanded addOtherCodesItem(IdentifierEntry otherCodesItem) {
  ...
  **/
  ...
  public ProgramExpanded addresses(List<Address> addresses) {
    
    this.addresses = addresses;
    return this;
  }

  public ProgramExpanded addAddressesItem(Address addressesItem) {
  ...
  **/
  ...
  public ProgramExpanded parent(ProgramPropertiesParent parent) {
  ...
  **/
  ...
  public ProgramExpanded children(List<ProgramPropertiesChildrenInner> children) {
    
    this.children = children;
    return this;
  }

  public ProgramExpanded addChildrenItem(ProgramPropertiesChildrenInner childrenItem) {
  ...
  **/
  ...
  public ProgramExpanded coordinators(List<ProgramPropertiesCoordinatorsInner> coordinators) {
    
    this.coordinators = coordinators;
    return this;
  }

  public ProgramExpanded addCoordinatorsItem(ProgramPropertiesCoordinatorsInner coordinatorsItem) {
  ...
  **/
  ...
  public ProgramExpanded organization(ProgramPropertiesOrganization organization) {
  ...
  **/
  ...
  public ProgramExpanded consumers(List<Consumer> consumers) {
    
    this.consumers = consumers;
    return this;
  }

  public ProgramExpanded addConsumersItem(Consumer consumersItem) {
  ...
  **/
  ...
  public ProgramExpanded ext(Object ext) {
  ...
  **/
  ...
  public ProgramExpanded validFrom(LocalDate validFrom) {
  ...
  **/
  ...
  public ProgramExpanded validTo(LocalDate validTo) {
  ...
  **/
  ...
  public ProgramExpanded timelineOverrides(List<TimelineOverrideProgram> timelineOverrides) {
    
    this.timelineOverrides = timelineOverrides;
    return this;
  }

  public ProgramExpanded addTimelineOverridesItem(TimelineOverrideProgram timelineOverridesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProgramExpanded programExpanded = (ProgramExpanded) o;
    return Objects.equals(this.programId, programExpanded.programId) &&
        Objects.equals(this.primaryCode, programExpanded.primaryCode) &&
        Objects.equals(this.programType, programExpanded.programType) &&
        Objects.equals(this.name, programExpanded.name) &&
        Objects.equals(this.abbreviation, programExpanded.abbreviation) &&
        Objects.equals(this.description, programExpanded.description) &&
        Objects.equals(this.teachingLanguage, programExpanded.teachingLanguage) &&
        Objects.equals(this.studyLoad, programExpanded.studyLoad) &&
        Objects.equals(this.qualificationAwarded, programExpanded.qualificationAwarded) &&
        Objects.equals(this.modeOfStudy, programExpanded.modeOfStudy) &&
        Objects.equals(this.modeOfDelivery, programExpanded.modeOfDelivery) &&
        Objects.equals(this.duration, programExpanded.duration) &&
        Objects.equals(this.firstStartDate, programExpanded.firstStartDate) &&
        Objects.equals(this.levelOfQualification, programExpanded.levelOfQualification) &&
        Objects.equals(this.level, programExpanded.level) &&
        Objects.equals(this.sector, programExpanded.sector) &&
        Objects.equals(this.fieldsOfStudy, programExpanded.fieldsOfStudy) &&
        Objects.equals(this.enrollment, programExpanded.enrollment) &&
        Objects.equals(this.resources, programExpanded.resources) &&
        Objects.equals(this.learningOutcomes, programExpanded.learningOutcomes) &&
        Objects.equals(this.assessment, programExpanded.assessment) &&
        Objects.equals(this.admissionRequirements, programExpanded.admissionRequirements) &&
        Objects.equals(this.qualificationRequirements, programExpanded.qualificationRequirements) &&
        Objects.equals(this.link, programExpanded.link) &&
        Objects.equals(this.educationSpecification, programExpanded.educationSpecification) &&
        Objects.equals(this.otherCodes, programExpanded.otherCodes) &&
        Objects.equals(this.addresses, programExpanded.addresses) &&
        Objects.equals(this.parent, programExpanded.parent) &&
        Objects.equals(this.children, programExpanded.children) &&
        Objects.equals(this.coordinators, programExpanded.coordinators) &&
        Objects.equals(this.organization, programExpanded.organization) &&
        Objects.equals(this.consumers, programExpanded.consumers) &&
        Objects.equals(this.ext, programExpanded.ext) &&
        Objects.equals(this.validFrom, programExpanded.validFrom) &&
        Objects.equals(this.validTo, programExpanded.validTo) &&
        Objects.equals(this.timelineOverrides, programExpanded.timelineOverrides);
  }

  @Override
  public int hashCode() {
    return Objects.hash(programId, primaryCode, programType, name, abbreviation, description, teachingLanguage, studyLoad, qualificationAwarded, modeOfStudy, modeOfDelivery, duration, firstStartDate, levelOfQualification, level, sector, fieldsOfStudy, enrollment, resources, learningOutcomes, assessment, admissionRequirements, qualificationRequirements, link, educationSpecification, otherCodes, addresses, parent, children, coordinators, organization, consumers, ext, validFrom, validTo, timelineOverrides);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProgramExpanded {\n");
