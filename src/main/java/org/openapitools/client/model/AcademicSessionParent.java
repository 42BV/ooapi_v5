...
import org.openapitools.client.model.AcademicSessionChildrenInner;
import org.openapitools.client.model.AcademicSessionYear;
 ...
 */
@ApiModel(description = "The parent Academicsession of this session (e.g. fall semester 20xx where the current session is a week 40). This object is [`expandable`](#tag/academic_sessions_model)")
@JsonPropertyOrder({
  AcademicSessionParent.JSON_PROPERTY_ACADEMIC_SESSION_ID,
  AcademicSessionParent.JSON_PROPERTY_ACADEMIC_SESSION_TYPE,
  AcademicSessionParent.JSON_PROPERTY_PRIMARY_CODE,
  AcademicSessionParent.JSON_PROPERTY_NAME,
  AcademicSessionParent.JSON_PROPERTY_START_DATE,
  AcademicSessionParent.JSON_PROPERTY_END_DATE,
  AcademicSessionParent.JSON_PROPERTY_PARENT,
  AcademicSessionParent.JSON_PROPERTY_CHILDREN,
  AcademicSessionParent.JSON_PROPERTY_YEAR,
  AcademicSessionParent.JSON_PROPERTY_OTHER_CODES,
  AcademicSessionParent.JSON_PROPERTY_CONSUMERS,
  AcademicSessionParent.JSON_PROPERTY_EXT
})
@JsonTypeName("AcademicSession_parent")
...
public class AcademicSessionParent {
  ...
  **/
  ...
  public AcademicSessionParent academicSessionType(String academicSessionType) {
  ...
  **/
  ...
  public AcademicSessionParent primaryCode(IdentifierEntry primaryCode) {
  ...
  **/
  ...
  public AcademicSessionParent name(List<LanguageTypedString> name) {
    
    this.name = name;
    return this;
  }

  public AcademicSessionParent addNameItem(LanguageTypedString nameItem) {
  ...
  **/
  ...
  public AcademicSessionParent startDate(LocalDate startDate) {
  ...
  **/
  ...
  public AcademicSessionParent endDate(LocalDate endDate) {
  ...
  **/
  ...
  public AcademicSessionParent parent(AcademicSessionParent parent) {
  ...
  **/
  ...
  public AcademicSessionParent children(List<AcademicSessionChildrenInner> children) {
    
    this.children = children;
    return this;
  }

  public AcademicSessionParent addChildrenItem(AcademicSessionChildrenInner childrenItem) {
  ...
  **/
  ...
  public AcademicSessionParent year(AcademicSessionYear year) {
  ...
  **/
  ...
  public AcademicSessionParent otherCodes(List<IdentifierEntry> otherCodes) {
    
    this.otherCodes = otherCodes;
    return this;
  }

  public AcademicSessionParent addOtherCodesItem(IdentifierEntry otherCodesItem) {
  ...
  **/
  ...
  public AcademicSessionParent consumers(List<Consumer> consumers) {
    
    this.consumers = consumers;
    return this;
  }

  public AcademicSessionParent addConsumersItem(Consumer consumersItem) {
  ...
  **/
  ...
  public AcademicSessionParent ext(Object ext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AcademicSessionParent academicSessionParent = (AcademicSessionParent) o;
    return Objects.equals(this.academicSessionId, academicSessionParent.academicSessionId) &&
        Objects.equals(this.academicSessionType, academicSessionParent.academicSessionType) &&
        Objects.equals(this.primaryCode, academicSessionParent.primaryCode) &&
        Objects.equals(this.name, academicSessionParent.name) &&
        Objects.equals(this.startDate, academicSessionParent.startDate) &&
        Objects.equals(this.endDate, academicSessionParent.endDate) &&
        Objects.equals(this.parent, academicSessionParent.parent) &&
        Objects.equals(this.children, academicSessionParent.children) &&
        Objects.equals(this.year, academicSessionParent.year) &&
        Objects.equals(this.otherCodes, academicSessionParent.otherCodes) &&
        Objects.equals(this.consumers, academicSessionParent.consumers) &&
        Objects.equals(this.ext, academicSessionParent.ext);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcademicSessionParent {\n");
