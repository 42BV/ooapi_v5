 ...
 */
@ApiModel(description = "The organization which provides this component. [`expandable`](#tag/organization_model) By default only the `organizationId` (a string) is returned. If the client requested an expansion of `organization` the full organization object should be returned. ")
@JsonPropertyOrder({
  ComponentOrganization.JSON_PROPERTY_ORGANIZATION_ID,
  ComponentOrganization.JSON_PROPERTY_PRIMARY_CODE,
  ComponentOrganization.JSON_PROPERTY_ORGANIZATION_TYPE,
  ComponentOrganization.JSON_PROPERTY_NAME,
  ComponentOrganization.JSON_PROPERTY_SHORT_NAME,
  ComponentOrganization.JSON_PROPERTY_DESCRIPTION,
  ComponentOrganization.JSON_PROPERTY_ADDRESSES,
  ComponentOrganization.JSON_PROPERTY_LINK,
  ComponentOrganization.JSON_PROPERTY_LOGO,
  ComponentOrganization.JSON_PROPERTY_OTHER_CODES,
  ComponentOrganization.JSON_PROPERTY_PARENT,
  ComponentOrganization.JSON_PROPERTY_CHILDREN,
  ComponentOrganization.JSON_PROPERTY_CONSUMERS,
  ComponentOrganization.JSON_PROPERTY_EXT
})
@JsonTypeName("Component_organization")
...
public class ComponentOrganization {
  ...
  **/
  ...
  public ComponentOrganization primaryCode(IdentifierEntry primaryCode) {
  ...
  **/
  ...
  public ComponentOrganization organizationType(OrganizationType organizationType) {
  ...
  **/
  ...
  public ComponentOrganization name(List<LanguageTypedString> name) {
    
    this.name = name;
    return this;
  }

  public ComponentOrganization addNameItem(LanguageTypedString nameItem) {
  ...
  **/
  ...
  public ComponentOrganization shortName(String shortName) {
  ...
  **/
  ...
  public ComponentOrganization description(List<LanguageTypedString> description) {
    
    this.description = description;
    return this;
  }

  public ComponentOrganization addDescriptionItem(LanguageTypedString descriptionItem) {
  ...
  **/
  ...
  public ComponentOrganization addresses(List<Address> addresses) {
    
    this.addresses = addresses;
    return this;
  }

  public ComponentOrganization addAddressesItem(Address addressesItem) {
  ...
  **/
  ...
  public ComponentOrganization link(URI link) {
  ...
  **/
  ...
  public ComponentOrganization logo(URI logo) {
  ...
  **/
  ...
  public ComponentOrganization otherCodes(List<IdentifierEntry> otherCodes) {
    
    this.otherCodes = otherCodes;
    return this;
  }

  public ComponentOrganization addOtherCodesItem(IdentifierEntry otherCodesItem) {
  ...
  **/
  ...
  public ComponentOrganization parent(OrganizationParent parent) {
  ...
  **/
  ...
  public ComponentOrganization children(List<OrganizationChildrenInner> children) {
    
    this.children = children;
    return this;
  }

  public ComponentOrganization addChildrenItem(OrganizationChildrenInner childrenItem) {
  ...
  **/
  ...
  public ComponentOrganization consumers(List<Consumer> consumers) {
    
    this.consumers = consumers;
    return this;
  }

  public ComponentOrganization addConsumersItem(Consumer consumersItem) {
  ...
  **/
  ...
  public ComponentOrganization ext(Object ext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComponentOrganization componentOrganization = (ComponentOrganization) o;
    return Objects.equals(this.organizationId, componentOrganization.organizationId) &&
        Objects.equals(this.primaryCode, componentOrganization.primaryCode) &&
        Objects.equals(this.organizationType, componentOrganization.organizationType) &&
        Objects.equals(this.name, componentOrganization.name) &&
        Objects.equals(this.shortName, componentOrganization.shortName) &&
        Objects.equals(this.description, componentOrganization.description) &&
        Objects.equals(this.addresses, componentOrganization.addresses) &&
        Objects.equals(this.link, componentOrganization.link) &&
        Objects.equals(this.logo, componentOrganization.logo) &&
        Objects.equals(this.otherCodes, componentOrganization.otherCodes) &&
        Objects.equals(this.parent, componentOrganization.parent) &&
        Objects.equals(this.children, componentOrganization.children) &&
        Objects.equals(this.consumers, componentOrganization.consumers) &&
        Objects.equals(this.ext, componentOrganization.ext);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComponentOrganization {\n");
