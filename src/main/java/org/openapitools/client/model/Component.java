...
import org.openapitools.client.model.ComponentCourse;
import org.openapitools.client.model.ComponentOrganization;
 ...
 */
@ApiModel(description = "A component is a part of a course")
@JsonPropertyOrder({
...
public class Component {
  ...
  **/
  ...
  @ApiModelProperty(example = "123e4567-e89b-12d3-a456-426614174000", required = true, value = "Unique id of this component")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[{language=en-GB, value=Written test for INFOMQNM}]", required = true, value = "The name of this component")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Test-INFOMQNM", required = true, value = "The abbreviation of this component")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "P1DT30H4S", value = "The duration of this component. The duration format is from the ISO 8601 ABNF as given in Appendix A of RFC 3339.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "nld", required = true, value = "The (primary) teaching language in which this component is given, should be a three-letter language code as specified by ISO 639-2.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Addresses for this component")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(componentId, primaryCode, componentType, name, abbreviation, modeOfDelivery, duration, description, teachingLanguage, learningOutcomes, enrollment, resources, assessment, addresses, otherCodes, course, organization, consumers, ext);
  }
