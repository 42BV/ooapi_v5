...
@JsonPropertyOrder({
  CoursePropertiesOrganization.JSON_PROPERTY_ORGANIZATION_ID,
  CoursePropertiesOrganization.JSON_PROPERTY_PRIMARY_CODE,
  CoursePropertiesOrganization.JSON_PROPERTY_ORGANIZATION_TYPE,
  CoursePropertiesOrganization.JSON_PROPERTY_NAME,
  CoursePropertiesOrganization.JSON_PROPERTY_SHORT_NAME,
  CoursePropertiesOrganization.JSON_PROPERTY_DESCRIPTION,
  CoursePropertiesOrganization.JSON_PROPERTY_ADDRESSES,
  CoursePropertiesOrganization.JSON_PROPERTY_LINK,
  CoursePropertiesOrganization.JSON_PROPERTY_LOGO,
  CoursePropertiesOrganization.JSON_PROPERTY_OTHER_CODES,
  CoursePropertiesOrganization.JSON_PROPERTY_PARENT,
  CoursePropertiesOrganization.JSON_PROPERTY_CHILDREN,
  CoursePropertiesOrganization.JSON_PROPERTY_CONSUMERS,
  CoursePropertiesOrganization.JSON_PROPERTY_EXT
})
@JsonTypeName("CourseProperties_organization")
...
public class CoursePropertiesOrganization {
  ...
  public CoursePropertiesOrganization() { 
  }
  ...
  **/
  ...
  public CoursePropertiesOrganization primaryCode(IdentifierEntry primaryCode) {
  ...
  **/
  ...
  public CoursePropertiesOrganization organizationType(OrganizationType organizationType) {
  ...
  **/
  ...
  public CoursePropertiesOrganization name(List<LanguageTypedString> name) {
    
    this.name = name;
    return this;
  }

  public CoursePropertiesOrganization addNameItem(LanguageTypedString nameItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization shortName(String shortName) {
  ...
  **/
  ...
  public CoursePropertiesOrganization description(List<LanguageTypedString> description) {
    
    this.description = description;
    return this;
  }

  public CoursePropertiesOrganization addDescriptionItem(LanguageTypedString descriptionItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization addresses(List<Address> addresses) {
    
    this.addresses = addresses;
    return this;
  }

  public CoursePropertiesOrganization addAddressesItem(Address addressesItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization link(URI link) {
  ...
  **/
  ...
  public CoursePropertiesOrganization logo(URI logo) {
  ...
  **/
  ...
  public CoursePropertiesOrganization otherCodes(List<IdentifierEntry> otherCodes) {
    
    this.otherCodes = otherCodes;
    return this;
  }

  public CoursePropertiesOrganization addOtherCodesItem(IdentifierEntry otherCodesItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization parent(OrganizationParent parent) {
  ...
  **/
  ...
  public CoursePropertiesOrganization children(List<OrganizationChildrenInner> children) {
    
    this.children = children;
    return this;
  }

  public CoursePropertiesOrganization addChildrenItem(OrganizationChildrenInner childrenItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization consumers(List<Consumer> consumers) {
    
    this.consumers = consumers;
    return this;
  }

  public CoursePropertiesOrganization addConsumersItem(Consumer consumersItem) {
  ...
  **/
  ...
  public CoursePropertiesOrganization ext(Object ext) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CoursePropertiesOrganization coursePropertiesOrganization = (CoursePropertiesOrganization) o;
    return Objects.equals(this.organizationId, coursePropertiesOrganization.organizationId) &&
        Objects.equals(this.primaryCode, coursePropertiesOrganization.primaryCode) &&
        Objects.equals(this.organizationType, coursePropertiesOrganization.organizationType) &&
        Objects.equals(this.name, coursePropertiesOrganization.name) &&
        Objects.equals(this.shortName, coursePropertiesOrganization.shortName) &&
        Objects.equals(this.description, coursePropertiesOrganization.description) &&
        Objects.equals(this.addresses, coursePropertiesOrganization.addresses) &&
        Objects.equals(this.link, coursePropertiesOrganization.link) &&
        Objects.equals(this.logo, coursePropertiesOrganization.logo) &&
        Objects.equals(this.otherCodes, coursePropertiesOrganization.otherCodes) &&
        Objects.equals(this.parent, coursePropertiesOrganization.parent) &&
        Objects.equals(this.children, coursePropertiesOrganization.children) &&
        Objects.equals(this.consumers, coursePropertiesOrganization.consumers) &&
        Objects.equals(this.ext, coursePropertiesOrganization.ext);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoursePropertiesOrganization {\n");
