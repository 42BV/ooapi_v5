...
public enum EducationSpecificationType {
  ...
  EducationSpecificationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static EducationSpecificationType fromValue(String value) {
    for (EducationSpecificationType b : EducationSpecificationType.values()) {
