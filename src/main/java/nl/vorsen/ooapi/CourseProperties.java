...
public class CourseProperties {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(primaryCode, name, abbreviation, studyLoad, modeOfDelivery, duration, firstStartDate, description, teachingLanguage, fieldsOfStudy,
                learningOutcomes, admissionRequirements, qualificationRequirements, level, enrollment, resources, assessment, link, educationSpecification,
                addresses, otherCodes, consumers, ext, programs, coordinators, organization);
    }
