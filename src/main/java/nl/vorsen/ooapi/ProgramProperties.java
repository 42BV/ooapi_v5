...
public class ProgramProperties {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(primaryCode, programType, name, abbreviation, description, teachingLanguage, studyLoad, qualificationAwarded, modeOfStudy,
                modeOfDelivery, duration, firstStartDate, levelOfQualification, level, sector, fieldsOfStudy, enrollment, resources, learningOutcomes,
                assessment, admissionRequirements, qualificationRequirements, link, educationSpecification, otherCodes, addresses, parent, children,
                coordinators, organization, consumers, ext);
    }
